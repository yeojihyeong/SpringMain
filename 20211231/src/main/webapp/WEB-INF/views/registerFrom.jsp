                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="register.do" onsubmit="return FormCheck()" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                    <button type="submit" class="btn btn-primary btn-user btn-block" onclick="isIdCheck()" id="idCheck" value="NO">아이디중복체크</button>
                                ...
                                <a href="main.do" class="btn btn-facebook btn-user btn-block">
